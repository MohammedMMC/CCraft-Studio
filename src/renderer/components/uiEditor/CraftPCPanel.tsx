...
export const CraftPCPanel: React.FC = () => {
  ...
  const [canvasSize, setCanvasSize] = useState({ width: termWidth * CC_CHAR_WIDTH, height: termHeight * CC_CHAR_HEIGHT });
  ...
  function updateCanvasSize(packet: craftpcHelpers.PacketTermChange) {
    const newcanvasSize = { width: packet.width * CC_CHAR_WIDTH, height: packet.height * CC_CHAR_HEIGHT };
