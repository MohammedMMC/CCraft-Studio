...
export const CloudIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="16" height="16" className={className || "fill-app-text-dim"}>
...
export const ElementIcons: React.FC<{ name: UIElementType }> = ({ name }) => {
  return ({
    ...
    panel: () => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="16" height="16" className="text-app-text-dim fill-app-text-dim stroke-app-text-dim">
        <path d="M64 183.4C44.9 172.4 32 151.7 32 128C32 92.7 60.7 64 96 64C119.7 64 140.4 76.9 151.4 96H488.5C499.6 76.9 520.2 64 543.9 64C579.2 64 607.9 92.7 607.9 128C607.9 151.7 595 172.4 575.9 183.4V456.5C595 467.6 607.9 488.2 607.9 511.9C607.9 547.2 579.2 575.9 543.9 575.9C520.2 575.9 499.5 563 488.5 543.9H151.4C140.3 563 119.7 575.9 96 575.9C60.7 575.9 32 547.2 32 511.9C32 488.2 44.9 467.5 64 456.5V183.4ZM512 183.4C502.3 177.8 494.2 169.7 488.6 160H151.4C145.8 169.7 137.7 177.8 128 183.4V456.5C137.7 462.1 145.8 470.2 151.4 479.9H488.5C494.1 470.2 502.2 462.1 511.9 456.5V183.4H512ZM288 384H320C364.2 384 400 348.2 400 304H432C449.7 304 464 318.3 464 336V400C464 417.7 449.7 432 432 432H320C302.3 432 288 417.7 288 400V384Z" />
        <path d="M250.518 201C256.657 201 262.242 204.695 264.59 210.377L266.874 215.904H266.865C298.241 290.964 316.249 333.98 320.819 344.938C324.07 352.703 320.382 361.598 312.616 364.826C304.854 368.053 295.935 364.403 292.689 356.649V356.648L282.532 332.364H218.468L208.311 356.648V356.649C205.065 364.403 196.146 368.053 188.384 364.826C180.618 361.598 176.93 352.703 180.181 344.938C184.863 333.713 203.645 288.849 236.452 210.361C238.804 204.688 244.383 201 250.518 201ZM231.203 301.935H269.832L250.518 255.742L231.203 301.935Z" stroke-width="6" />
      </svg>
    ),
    progressbar: () => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="16" height="16" className="text-app-text-dim fill-app-text-dim">
