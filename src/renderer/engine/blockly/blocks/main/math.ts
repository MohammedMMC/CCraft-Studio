...
export const mathBlocksGenerators: Record<string, GeneratorFunc> = {
    'math_number': (block, gen) => {
        return [String(block.getFieldValue('NUM')), Order.ATOMIC];
    },
    'math_arithmetic': (block, gen) => {
