    ...
    contents: [
      ...
      // Category: Interfaces
      {
        ...
        contents: [
          ...
          { kind: 'label', text: '--- Elements ---' },
          { kind: 'block', type: 'ui_set_prop' },
          { kind: 'block', type: 'ui_get_prop' },
          { kind: 'block', type: 'ui_set_prop_byname', inputs: { ELEMENT: { block: { type: 'text', fields: { TEXT: 'element1' } } } } },
          { kind: 'block', type: 'ui_get_prop_byname', inputs: { ELEMENT: { block: { type: 'text', fields: { TEXT: 'element1' } } } } },
